...
<jsp:useBean id="productBean" class="com.ecommerce.ProductBean" scope="session"></jsp:useBean>
        ...
        <jsp:setProperty property="price" name="productBean" value="600.00"/>
         ...
         <jsp:setProperty property="productId" name="productBean" value="18970"/>
        <jsp:setProperty property="productName" name="productBean" value="Optical wireless Keyboard"/>
        <jsp:setProperty property="price" name="productBean" value="1000.00"/>
